...
public class DataNotAcceptableException extends ServicesException {
    ...
    /**
     * <p>
     * Java constructor for DataNotAcceptableException with an Integer code argument, calls constructor with default message.
     * </p>
     *
     * @param message code param is given
     */
    public DataNotAcceptableException(final String message) {
        super(message);
    }
