...
class SuccessResponseTest {
    ...
    void testSuccessResponseConstructor() {
        ...
        SuccessResponse<Object> successResponse = new SuccessResponse<>(SuccessCode.SUCCESS, paged, HttpStatus.OK);
    ...
    void testSuccessResponseConstructorEntity() {
        ...
        SuccessResponse<Object> successResponse = new SuccessResponse<>(SuccessCode.SUCCESS, user, HttpStatus.OK);
        assertEquals(HttpStatus.OK, successResponse.getStatusCode());
    }
    @Test
    ...
    void testSuccessResponseConstructorCountOfEntity() {
        List<Object> user = List.of(mock(User.class));
        SuccessResponse<Object> successResponse = new SuccessResponse<>(SuccessCode.SUCCESS, user,1, HttpStatus.OK);
        assertEquals(HttpStatus.OK, successResponse.getStatusCode());
    }
    ...
    void successResponseConstructor() {
        SuccessResponse<Object> successResponse = new SuccessResponse<>(SuccessCode.SUCCESS, HttpStatus.OK);
        assertEquals(HttpStatus.OK, successResponse.getStatusCode());
    }
    ...
    void testSuccessResponseConstructorEntityCount() {
        List<Object> user = List.of(mock(User.class));
        SuccessResponse<Object> successResponse = new SuccessResponse<>(SuccessCode.SUCCESS, user, HttpStatus.OK, Long.valueOf(1));
        assertEquals(HttpStatus.OK, successResponse.getStatusCode());
    }

    @Test
    void testCountEndSuccessResponseConstructorAdditionalArguments() {
        SuccessResponse<Object> successResponse = new SuccessResponse<>(SuccessCode.SUCCESS, new Object(), HttpStatus.OK, "arg1", "arg2");
        assertEquals(HttpStatus.OK, successResponse.getStatusCode());
    }
    ...
    void testCountEndSuccessResponseConstructorAdditionalArgumentsCount() {
        SuccessResponse<Object> successResponse = new SuccessResponse<>(SuccessCode.SUCCESS, new Object(), 1,HttpStatus.OK, "arg1", "arg2");
        assertEquals(HttpStatus.OK, successResponse.getStatusCode());
    }
